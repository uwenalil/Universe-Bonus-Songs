...
--(its configured to be used on the test song)
    ...
    local charid = "gf" --it doesn´t matter what you put in here, it just has to be different than any other charid of the scripts in the folder

    local id = 666 --only numbers, and as charid, always different than any other id of the scripts in the folder
    ...
    local charimg = "furrygf-assets" --use the image name from image/characters

    local charpath ="characters/" -- in case you want to use another path

    local charorder = 3 --use this if you want your character to be behind something, i used 1000 but normally you dont need more than 20
 
    local flipx = false --in case you want to... well... flip your character x, this will break your offsets if you have any

    local scale = 0.29

    local notename = "gf" --what notetype will the character sing 

    local cameraoffset = {0,0} --for the IC camera event

    local charpos = {570, 430} --position of the character in the stage
                     --x,y
    ...
    [1] = {"gf idle dance0",    16,          false,        0,          0,         "idle"},
    ...
    [2] = {"socks left0",24,false,0,0,"left"},                          --left

    [3] = {"socks down0",24,false,0,0,"down"},                          --down

    [4] = {"socks up0",24,false,0,0,"up"},                               --up

    [5] = {"socks right0",24,false,0,0,"right"},                         --right

       
    [6] = {"none",24,false,-34,19,"left-alt"},                --left-alt
    
    [7] = {"none",24,false,-23,-16,"down-alt"},                --down-alt

    [8] = {"none",24,false,4,27,"up-alt"},                       --up-alt

    [9] = {"none",24,false,46,22,"right-alt"},                --right-alt
