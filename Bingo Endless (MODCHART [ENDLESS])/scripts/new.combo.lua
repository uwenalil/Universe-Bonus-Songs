-- Settings (Player) --
    ...
    local foreverComboCount = false       -- Shows combo number like forever engine 
    local countMisses = false              -- forever engine is pretty cool

    local missSprite = false               -- Show a thing when you fuck up
...
-- Settings (Opponent) --
    ...
    local randGoods = true -- Makes some goods occasionally appear 
    local randBads  = true -- Makes some bads occasionally appear         | Should you turn all these on? Probably not
    local randShits = true -- Makes some shits occasionally appear 
    local chanceGood
    local chanceBad 
    local chanceShit
